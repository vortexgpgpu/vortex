// Needleman-Wunsch anti-diagonal wavefront kernels (ported from Rodinia).
// Each work-group loads a BLOCK_SIZE x BLOCK_SIZE tile of the score matrix into
// local memory, fills it along anti-diagonals, and writes it back. nw_kernel1
// sweeps the upper-left triangle of tiles, nw_kernel2 the lower-right triangle.
// BLOCK_SIZE is supplied at build time via -D BLOCK_SIZE=<n>.
