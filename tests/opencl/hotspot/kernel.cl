// HotSpot transient-thermal stencil kernel (ghost-zone / pyramid blocking).
// Ported verbatim from Rodinia. Each 2-D BLOCK_SIZE x BLOCK_SIZE work-group
// advances `iteration` time steps over a halo-padded tile cached in local
// memory. BLOCK_SIZE is supplied at build time via -DBLOCK_SIZE.
