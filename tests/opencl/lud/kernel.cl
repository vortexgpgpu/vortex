// LU decomposition (Rodinia LUD) — blocked three-phase kernels.
// Ported verbatim from Rodinia's lud_kernel.cl. BLOCK_SIZE is supplied at
// build time via clBuildProgram "-D BLOCK_SIZE=...".
