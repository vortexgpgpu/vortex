...
// modes 3/4 — the two DTCU placement variants. The whole GEMM is one descriptor: the
...
// mode 3: engine at cluster scope, D lands in L2.
...
// mode 4: engine at socket scope, D lands in that socket's L1 dcache.
