...
#define VX_CSR_DFV_ICACHE_FILL_REQ_STALL   0x7C1  // ICache LFSR-based stall enable (bit 0)
...
#define VX_CSR_DFV_DCACHE_FILL_REQ_STALL   0x7C4  // DCache request LFSR-based stall enable (bit 0)
