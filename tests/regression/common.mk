...
ifeq ($(TARGET), hw)
	VORTEX_FIRESIM_XCLBIN=$(FIRESIM_XCLBIN) LD_LIBRARY_PATH=$(XILINX_XRT)/lib:$(VORTEX_RT_LIB):$(LD_LIBRARY_PATH) VORTEX_DRIVER=firesim ./$(PROJECT) $(OPTS)
else
	XCL_EMULATION_MODE=$(TARGET) EMCONFIG_PATH=$(FIRESIM_EMCONFIG_DIR) VORTEX_FIRESIM_XCLBIN=$(FIRESIM_XCLBIN) LD_LIBRARY_PATH=$(XILINX_XRT)/lib:$(VORTEX_RT_LIB):$(LD_LIBRARY_PATH) VORTEX_DRIVER=firesim ./$(PROJECT) $(OPTS)
endif
