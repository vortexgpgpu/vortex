...
$(VORTEX_RT_PATH)/libvortex.so:
	$(RUNTIME_ARGS) $(MAKE) -C $(VORTEX_RT_PATH)
...
run-xrt: $(PROJECT) kernel.vxbin
	$(RUNTIME_ARGS) $(MAKE) -C $(VORTEX_RT_PATH)/xrt
ifeq ($(TARGET), hw)
