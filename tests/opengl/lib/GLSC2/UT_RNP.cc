...
GLsizei bufSize = WIDTH*HEIGHT*4;
  ...
  void *ini_buff = createBuffer(MEM_READ_WRITE, bufSize, NULL);
  ...
  setKernelArg(_readnpixels_kernel, 0, sizeof(void*), &ini_buff);
  ...
  size_t global_work_size= bufSize/4;
  ...
  CL_CHECK(clEnqueueReadBuffer(commandQueue, dst_buff, CL_TRUE, 0, bufSize, h_b, 0, NULL, NULL));
