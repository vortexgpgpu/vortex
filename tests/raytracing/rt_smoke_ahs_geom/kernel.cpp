...
//
// PRISM RTU any-hit candidate geometry-attribute smoke kernel — candidate-
// return loop.
//
// A non-opaque triangle returns an any-hit candidate to the warp. The kernel
// reads the CANDIDATE attributes (geometry_index, instance_id) from the
// register window, stashes them into the trace payload buffer, and ACCEPTs so
