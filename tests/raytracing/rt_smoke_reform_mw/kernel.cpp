...
//
// PRISM RTU reformation multi-warp smoke kernel — candidate-return loop.
//
...
// keep them separated by warp_id (no cross-warp CB_YIELD). Each warp
// ACCEPTs its candidate via vx_rt_continue until a terminal status.
