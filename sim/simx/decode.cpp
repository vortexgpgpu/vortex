...
static const char *op_string(const Instr &instr) {
  ...
  case Opcode::R_W:
    if (func7 & 0x1) {
      ...
      switch (func3) {
      case 0:
        return (func7 & 0x20) ? "SUBW" : "ADDW";
      case 1:
        return "SLLW";
      case 5:
        return (func7 & 0x20) ? "SRAW" : "SRLW";
      default:
        std::abort();
      }
    }
  ...
  case Opcode::EXT1:
    ...
    case 0:
      ...
      case 1:
        return "WSPAWN";
      case 2:
        return rs1 ? "SPLIT.N" : "SPLIT";
      case 3:
        return "JOIN";
      case 4:
        return "BAR";
      case 5:
        return rd ? "PRED.N" : "PRED";
      default:
        std::abort();
      }
    default:
  ...
  case Opcode::TCU:
    switch (func3) {
    case 0:
      return "ML"; // Matrix Load
    case 1:
      return "MS"; // Matrix Store
    case 2:
      return "MATMUL"; // Matrix Multiply
    default:
      std::abort();
    }
  default:
