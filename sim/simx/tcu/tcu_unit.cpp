...
// The PE arithmetic (FMA / FEDP) moved to tcu/tcu_fedp.h so the DTCU's MAC array uses
// the same multiply instead of its own copy. Same definitions, same results.
