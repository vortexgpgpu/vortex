...
module vortex_afu_shim import local_mem_cfg_pkg::*; import ccip_if_pkg::*; (
  ...
  output t_local_mem_data     avs_writedata [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  input  t_local_mem_data     avs_readdata [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  output t_local_mem_addr     avs_address [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  input  logic                avs_waitrequest [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  output logic                avs_write [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  output logic                avs_read [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  output t_local_mem_byte_mask avs_byteenable [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  output t_local_mem_burst_cnt avs_burstcount [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS],
  input                       avs_readdatavalid [`VX_CFG_PLATFORM_MEMORY_NUM_BANKS]
);
...
vortex_afu #(
  .NUM_LOCAL_MEM_BANKS(`VX_CFG_PLATFORM_MEMORY_NUM_BANKS)
) afu (
    .clk(clk),
    .reset(reset),
