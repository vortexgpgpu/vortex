...
CONFIGS="-DEXT_GFX_ENABLE" ./ci/blackbox.sh --driver=vlsim  --app=draw3d --args="-tbox.cgltrace -rbox_ref_128.png"
...
CONFIGS="-DSMEM_NUM_BANKS=2 -DDCACHE_NUM_BANKS=2" ./ci/blackbox.sh --driver=sim
