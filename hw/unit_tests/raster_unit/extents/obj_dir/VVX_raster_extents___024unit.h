...
#ifndef _VVX_RASTER_EXTENTS___024UNIT_H_
#define _VVX_RASTER_EXTENTS___024UNIT_H_  // guard
...
VL_MODULE(VVX_raster_extents___024unit) {
  public:
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(VVX_raster_extents___024unit);  ///< Copying not allowed
  public:
    VVX_raster_extents___024unit(const char* name = "TOP");
    ~VVX_raster_extents___024unit();
