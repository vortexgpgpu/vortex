...
module VX_dxa_setup import VX_gpu_pkg::*, VX_dxa_pkg::*; (
    ...
    output wire [DXA_COMPLETION_REF_W-1:0] active_bar_addr,
    ...
    wire [DXA_COMPLETION_REF_W-1:0] launch_bar_addr;
`ifdef VX_CFG_DXA_SBAR_ENABLE
    assign launch_bar_addr =
        req_data.meta[4 +: DXA_COMPLETION_REF_W];
...
`endif
    ...
    reg [DXA_COMPLETION_REF_W-1:0]         r_bar_addr;
    ...
    reg [DXA_COMPLETION_REF_W-1:0]         s_bar_addr;
    ...
    assign setup_params.dest_mode          = r_dest_mode;
