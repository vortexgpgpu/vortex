...
`endif
    ...
    logic decode_is_mem, decode_is_long_mem; 
    assign decode_is_mem = (opcode == INST_L); // || (opcode == INST_S);
    assign decode_is_long_mem = decode_is_mem; 

    assign decode_sched_if.is_long_mem = decode_is_long_mem;
