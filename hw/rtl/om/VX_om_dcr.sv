...
module VX_om_dcr import VX_gpu_pkg::*, VX_om_pkg::*; #(
        ...
        if (write_valid) begin
            case (write_addr)
                ...
                `VX_DCR_OM_STENCIL_REF: begin
                    ...
                    dcrs.stencil_ref[1] <= write_data[16 +: `VX_OM_STENCIL_BITS];
                end
                `VX_DCR_OM_STENCIL_MASK: begin
                    dcrs.stencil_mask[0] <= write_data[0 +: `VX_OM_STENCIL_BITS];
                    dcrs.stencil_mask[1] <= write_data[16 +: `VX_OM_STENCIL_BITS];
                end
                `VX_DCR_OM_STENCIL_WRITEMASK: begin
                    dcrs.stencil_writemask[0] <= write_data[0 +: `VX_OM_STENCIL_BITS];
