...
#ipx::associate_bus_interfaces -busif m_axi_mem0 -clock ap_clk $core
#ipx::associate_bus_interfaces -busif m_axi_mem1 -clock ap_clk $core
#ipx::associate_bus_interfaces -busif m_axi_mem2 -clock ap_clk $core
